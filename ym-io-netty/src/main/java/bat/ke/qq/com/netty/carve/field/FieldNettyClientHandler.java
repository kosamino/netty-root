 ...
 */
public class FieldNettyClientHandler extends SimpleChannelInboundHandler<ByteBuf> {

    public static String SYMBOL="Ant";

    private static final Logger logger = Logger.getLogger(FieldNettyClientHandler.class.getName());
