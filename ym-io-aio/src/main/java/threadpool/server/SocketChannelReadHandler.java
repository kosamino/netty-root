 ...
 * FileName: SocketChannelReadHandler
 * Author:   houjing
...
public class SocketChannelReadHandler  implements CompletionHandler<Integer, StringBuffer> {
     ...
     * 日志
     */
    private static final Log LOGGER = LogFactory.getLog(SocketChannelReadHandler.class);
    ...
    public void completed(Integer result, StringBuffer historyContext) {
        ...
        if(result == -1) {
            try {
                ...
                SocketChannelReadHandler.LOGGER.error(e);
            }
            return;
        }

        SocketChannelReadHandler.LOGGER.info("completed(Integer result, Void attachment) : 然后我们来取出通道中准备好的值");
        /*
        ...
        try {
            ...
            SocketChannelReadHandler.LOGGER.info("================目前的传输结果：" + historyContext);
        ...
        if(historyContext.indexOf("over") == -1) {
            ...
            this.byteBuffer.clear();
            SocketChannelReadHandler.LOGGER.info("客户端发来的信息======message : " + historyContext);
        ...
        //=========================================================================
        SocketChannelReadHandler.LOGGER.info("=======收到完整信息，开始处理业务=========");
    ...
    public void failed(Throwable exc, StringBuffer historyContext) {
        SocketChannelReadHandler.LOGGER.info("=====发现客户端异常关闭，服务器将关闭TCP通道");
        try {
            this.socketChannel.close();
        } catch (IOException e) {
            SocketChannelReadHandler.LOGGER.error(e);
